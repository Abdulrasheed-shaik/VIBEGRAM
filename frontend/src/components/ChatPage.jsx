      ...
      </section>
      {
        selectedUser ? (
          <section className='flex-1 border-l-gray-300 flex flex-col h-full'>
            <div className='flex gap-2 items-center px-3 border-b border-gray-300 sticky top-0 bg-white z-10'>
            ...
            <div className='flex items-center p-4 border-t border-t-gray-300'>
              ...
              <Button onClick={()=>sendMessageHandler(selectedUser?._id)} className='rounded-3xl'>Send</Button>
            </div>
          </section>
        ) : (
          <div className='flex flex-col items-center justify-center mx-auto'>
            ...
            <span>Send a message to staet a chat </span>
          </div>
        )
      }
    </div>
